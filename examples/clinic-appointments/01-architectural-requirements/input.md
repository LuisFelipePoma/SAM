...
- `architecture-drivers.md` generated by the agent.
- ASR list.
- Quality scenarios.
- Utility tree.
- Driver list proposal.

## Approval Gate

Architect approves/corrects primary drivers, supporting drivers, metrics, priorities and tradeoffs before Architectural Design.

## Agent Role

Generate `architecture-drivers.md` from `project-brief.md` and this input. The architect keeps final decision authority.

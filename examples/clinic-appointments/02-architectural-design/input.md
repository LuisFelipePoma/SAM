...
Architect approves selected concepts, discarded alternatives and decisions before Architectural Documentation.

## Agent Role

Run ADD step by step, propose max 3 alternatives per driver and record tradeoffs.
